...
{
    public class ReviewsDeleteController : ApiController
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: api/ReviewsDelete
        public IQueryable<Review> GetReviews()
        {
            return db.Reviews;
        }

        // GET: api/ReviewsDelete/5
